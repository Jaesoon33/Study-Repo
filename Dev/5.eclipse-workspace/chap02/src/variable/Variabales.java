...
//		final String APP_NAME = "MyApp";
		...
		// PI = 3.111;		// 컴파일 오류 : final 변수는 재할당 불가함
	 ...
	 * 		int --> String		Integar.toString(num)
	 * 			간단한 방법		"(String)" + num -> 문자열로 캐스팅
	 */
	private static void typeCasting() {
		...
		// 자동 형변환
		int intValue = 100;
		long longValue = (long)intValue;		// int(4byte) --> long(8byte)
		double doubleValue = longValue;  // long(8byte) --> double(8byte)
				
		System.out.println("자동 형 변환: " + intValue + " -> " + longValue + " -> " + doubleValue);
...
//		String str3 = "" + num;
	...
	private static void referenceTypes() {
		System.out.println("1. 참조 타입");
		
		// String - 리터럴 방식 (String pool)
...
//		short s = 32767;				// 2byte: -32,768 ~ 32,767
//		int i = 2147483647;				// 4byte: -2,147,483,648 ~ 2,147,483,647
//		long l = 923345678654433444L;	// 8byte: 2^-63 ~ 6^43-1
//		
//		// 실수형 -float은 f 접미사 필수, double은 기본 타입
//		float f = 3.14157f;			// 4byte
//		double d = 3.141582435333; // 8byte
