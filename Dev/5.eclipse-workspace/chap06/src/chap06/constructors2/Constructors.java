...
class Book {
	...
	// 생성자 1: 기본 생성자
	public Book() {
		this("Unknown", "Unknown", 0, 0.0, "000-0-00-000000-0");
	};
	...
	public Book(String title, String author) {
		this(title, author, 0, 0.0, "000-0-00-000000-0"); 		
	}
 	
	// 생성자 3: 제목 + 저자 + 페이지 할당
	public Book(String title, String author, int pages) {
		this(title, author, pages, 0.0, "000-0-00-000000-0"); 		
	}	
