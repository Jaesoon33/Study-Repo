...
public class EnvironmentCheck {
	private static void printJavaInfo ( ) {
		...
		System.out.println("Java 벤더: " + System.getProperty("java.vender"));
	...
	private static void printMemoryInfo() {
		...
		System.out.println("사용중인 메모리: " + formatBytes(usedMemory));
		System.out.println("사용중 가능한 메모리: " + formatBytes(freeMemory));
