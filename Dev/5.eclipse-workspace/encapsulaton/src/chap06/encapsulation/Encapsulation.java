...
class StudentsWithGrades{
	 ...
	 public int scoreCount; // 현재 점수 개수
...
public class Encapsulation {
	public static void main(String[] args) {
		...
		System.out.println("\n\n---- Product 클래스 테스트 ----");
		StudentsWithGrades s1 = new StudentsWithGrades("이순신", "2026001"); // 인자를 이름과 학번만 받게되면 addScore 메소드 사용이 원할하나 인자를 배열까지 받게된다면 배열의 사이즈가 정해지므로 굳이 addScore 메소드를 사용할 의미가없음  
		s1.addScore(95);
		s1.addScore(88);
		s1.addScore(72);
		s1.addScore(90);
