// 대입 연산자와 비교 연산자 (Assign & Comparison Operators)
...
num += 5;   // num = num + 5;
console.log("num += 5 (num = num + 5) -> %d", num);
...
console.log("a === b (엄격한 비교) ->", a === b, "<-- 값, 타입 모두 비교 (recommaned)");
...
// 느슨한 비교(==)의 함정
console.log("\n[느슨한 비교(==)의 함정]");
console.log("0 == ' ' -> ", 0 == '', "<- 둘 다 false라서 같음");     
console.log("0 == false -> ", 0 == false, "<- 둘 다 false라서 같음");     
